...
<!--👨‍💻 Desarrollador Full-Stack apasionado por C# y .NET
¡Hola! Soy un desarrollador de software y web Full-Stack con una fuerte afinidad por C# y el ecosistema .NET. Me especializo en crear soluciones robustas y escalables, tanto en el frontend como en el backend. Actualmente, trabajo con tecnologías como ASP.NET Core y Angular, aprovechando herramientas modernas como Entity Framework para el manejo de bases de datos, y Visual Studio como mi entorno de desarrollo preferido. Además, tengo experiencia con control de versiones en Git y GitHub, lo que me permite colaborar eficientemente en proyectos de diferentes escalas.-->
